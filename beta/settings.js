...
function goto_tab(id) {
    switch (id) {
        case 0:
            ...
            document.getElementById("crafting_page").style.display = "none"
        ...
        switch (id) {
            ...
            case 3:
                if (game.galactic_bought[20]) {
                    ...
                    document.getElementById("crafting_page").style.display =
                        "block"
                    document.getElementById("expansion_page").style.display =
                        "none"
                    document.getElementById("dark_page").style.display = "none"
                    document.getElementById("galactic_page").style.display =
                        "none"
            ...
            case 4:
                if (game.expand >= 1) {
                    ...
                    if (game.statistics_unit[3] === 0) {
                        ...
                        document.getElementById("statistics_unit").innerHTML =
                            "Unit: EXOTIC SHARDS"
                    } else if (game.statistics_unit[3] === 2) {
                        document.getElementById("statistics_unit").innerHTML =
                            "Unit: EXPANSIONS"
                    }
